...
def _execute(filters):
    ...
    for inv in invoice_list:
        ...
        for account in unrealized_profit_loss_accounts:
            row.update(
                {frappe.scrub(account + "_unrealized")
...
def get_columns(invoice_list):
    ...
    columns += [
        ...
        {"label": _("Tax Id"), "fieldname": "tax_id",
         "fieldtype": "Data", "width": 120},
        {
        ...
        {"fieldname": "currency", "label": _(
            "Currency"), "fieldtype": "Data", "width": 80},
    ]
...
def get_conditions(filters):
    ...
    conditions += get_sales_invoice_item_field_condition(
        "mode_of_payment", "Sales Invoice Payment")
...
def get_invoices(filters):
    ...
    return frappe.db.sql(
        """
		select name, posting_date, debit_to, project, customer,month(posting_date),
